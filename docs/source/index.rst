...
When information is recorded in Indigo® it instantly becomes available to all other users who can
read and contribute information. Whilst designed to be transparent, sensitive information can be
restricted if required. Indigo® can also be used as a tasking tool, setting tasks to be actioned by
yourself or others.
